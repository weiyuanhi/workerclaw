...
<ParamField path="skills.workshop.playbooks.enabled" type="boolean" default="true">
  When `true`, `category=playbook` proposals target
  `&lt;workspace&gt;/skills/&lt;subdir&gt;/&lt;name&gt;/`. When `false`, playbook
  requests fall back to the flat `skills/&lt;name&gt;/` layout.
</ParamField>

<ParamField path="skills.workshop.playbooks.subdir" type="string" default="playbooks">
  Workspace subdirectory under `skills/` used for playbook targets.
</ParamField>
