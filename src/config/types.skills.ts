...
export type SkillsWorkshopPlaybooksConfig = {
  /** When false, playbook proposals target workspace/skills/<name>/ instead of skills/playbooks/. */
  enabled?: boolean;
  /** Workspace subdirectory under skills/ for playbook targets. Default: playbooks. */
  subdir?: string;
};
...
export type SkillsWorkshopConfig = {
  ...
  /** Learned business workflow playbooks stored under workspace skills/playbooks/. */
  playbooks?: SkillsWorkshopPlaybooksConfig;
