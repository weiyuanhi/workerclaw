...
const EXAMPLES = [
  ...
  [
    'openclaw agent --message "Summarize my inbox"',
    "Run one agent turn through the Gateway (results stay in the Control UI session).",
  ],
  ["openclaw dashboard", "Open the local Control UI command window."],
] as const;
