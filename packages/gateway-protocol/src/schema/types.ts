...
export type AcpCatalogParams = SchemaType<"AcpCatalogParams">;
export type AcpCatalogResult = SchemaType<"AcpCatalogResult">;
export type AcpHarnessAuthLoginParams = SchemaType<"AcpHarnessAuthLoginParams">;
export type AcpHarnessAuthLoginResult = SchemaType<"AcpHarnessAuthLoginResult">;
...
export type SkillsProposalRequestDraftPlaybookParams =
