...
const SkillProposalTargetSchema = Type.Object(
  {
    ...
    category: Type.Optional(Type.Union([Type.Literal("skill"), Type.Literal("playbook")])),
...
/** Starts an agent turn that drafts a playbook proposal from the current session. */
export const SkillsProposalRequestDraftPlaybookParamsSchema = Type.Object(
  {
    agentId: Type.Optional(NonEmptyString),
    targetAgentId: Type.Optional(NonEmptyString),
...
/** Chat-run acknowledgement returned after queueing a playbook draft request. */
