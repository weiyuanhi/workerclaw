                    ...
                    ${payloadLocked
                      ? html`
                          <label class="field cron-span-2">
                            ...
                            <input id="cron-payload-kind" .value=${t("cron.form.command")} readonly />
                          </label>
                        `
                      : html`
                    ...
                    ${isAgentTurn
                      ? html`
                          <label class="field cron-span-2">
                            ...
                            >
                              <option value="inherit">${t("cron.form.inheritGlobalSetting")}</option>
                              <option value="disabled">${t("cron.form.disableForThisJob")}</option>
                              <option value="custom">${t("cron.form.customPerJobSettings")}</option>
                            </select>
                          ...
                          ${props.form.failureAlertMode === "custom"
                            ? html`
                                ...
                                <label class="field">
                                  ...
                                  >
                                    <option value="announce">${t("cron.form.alertAnnounce")}</option>
                                    <option value="webhook">${t("cron.form.alertWebhook")}</option>
                                  </select>
                                </label>
                                <label class="field">
      ...
      <div class="cron-job-detail">
        ...
        ${payload.cwd
          ? html`<div class="cron-job-detail-section">
              <span class="cron-job-detail-label">${t("cron.form.cwd")}</span>
