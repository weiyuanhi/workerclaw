...
export const CONFIG_HINTS_ZH_CN: ConfigHintMaps = {
  ...
  "agents.defaults.mediaGenerationAutoProviderFallback": "Media Generation Auto 提供商 Fallback",
  "agents.defaults.pdfModel.primary": "PDF Model",
  "agents.defaults.pdfModel.fallbacks": "PDF Model Fallbacks",
  ...
  "agents.list[].sandbox.browser.network": "代理 Sandbox Browser Network",
  "agents.list[].sandbox.browser.cdpSourceRange": "代理 Sandbox Browser CDP Source Port Range",
