...
export const en: TranslationMap = {
  ...
  channels: {
    ...
    configOnly: {
      hint: "This channel is configured but not loaded by the gateway yet. Restart the gateway after installing the plugin, then refresh.",
    },
    weixin: {
      subtitle: "Scan the QR code with WeChat to link this channel.",
      qrAlt: "WeChat QR",
      qrHint: "After scanning, tap Confirm on your phone. Login is detected automatically.",
      waitingForConfirm: "Waiting for phone confirmation… (up to 2 minutes)",
      scanConfirm: "Confirm scan",
      scanConfirmTooltip:
        "After scanning with WeChat, tap Confirm on your phone. Click here to retry if auto-wait ended or the QR expired.",
    },
  ...
  configPage: {
    ...
    acp: {
      basicsTitle: "Basics",
      basicsHint:
        "Enable ACP, choose the acpx backend, and set the default coding agent (for example cursor).",
      pluginCalloutTitle: "Agent CLI paths live under Plugins",
      pluginCalloutBody:
        "Cursor CLI command, permission mode, and per-agent overrides are configured in Automation → Plugins → acpx.",
      goToPlugins: "Open plugin settings",
      advancedTitle: "Advanced options",
      advancedHint: "Fallback agents, concurrency limits, stream delivery, and runtime TTL tuning.",
      streamTitle: "Stream delivery",
      streamHint: "Controls how ACP output is chunked and delivered to the requesting channel.",
      runtimeTitle: "Runtime lifecycle",
      runtimeHint: "Session TTL and optional install command for ACP agent runtimes.",
      backendTitle: "ACP backend",
      backendSelectLabel: "Backend",
      backendSelectPlaceholder: "Not set",
      backendStatusHealthy: "Registered and healthy",
      backendStatusUnhealthy: "Registered but unhealthy",
      backendStatusRegistered: "Registered",
      backendStatusNotLoaded: "Not loaded in Gateway",
      backendStatusNotLoadedHint:
        "Not loaded in Gateway yet. Save your config so Gateway reloads plugins and registers this backend.",
      backendStatusHealthyHint: "Registered in Gateway and healthy.",
      backendStatusUnhealthyHint:
        "Registered in Gateway, but the health check failed. Save config and check Gateway logs if it persists.",
      backendStatusRegisteredHint: "Registered in Gateway.",
      backendCatalogEmpty: "No backend options available.",
      customBackendToggle: "Use custom backend",
      customBackendLabel: "Custom backend id",
      customBackendPlaceholder: "e.g. acpx",
      defaultAgentTitle: "Default harness",
      allowedAgentsTitle: "Allowed harnesses",
      customHarnessLabel: "Custom harness id",
      customHarnessPlaceholder: "e.g. my-tool",
      addCustomHarness: "Add custom",
      addCustomHarnessPlaceholder: "Type a custom harness id and press Enter",
      removeCustomHarness: "Remove {harnessId}",
      catalogLoading: "Refreshing live backend status from Gateway…",
      workspaceTitle: "ACP runtime directory",
      workspaceHint:
        "Default directory for ACP-bound sessions. When unset, OpenClaw uses the agent workspace.",
      workspaceAgentLabel: "Default OpenClaw agent: {agentId}",
      acpCwdLabel: "ACP binding default directory (optional)",
      acpCwdPlaceholderEmpty: "No agent workspace configured",
      acpCwdEffectiveConfigured: "Effective path: {path} (ACP binding override)",
      acpCwdEffectiveInherited: "Effective path: {path} (from agent workspace)",
      acpCwdEffectiveMissing:
        "No agent workspace detected. Configure one under Agents before ACP bindings can inherit a default directory.",
      acpCwdOverrideHint:
    ...
    sectionsMeta: {
      ...
      web: {
        label: "Web",
        description: "Web channel heartbeat, reconnect, and WhatsApp Web timing settings",
      },
      discovery: { label: "Discovery", description: "Service discovery and networking" },
      nodeHost: {
        label: "Node Host",
        description: "Capabilities this gateway node exposes to other nodes and clients",
      },
      ...
      media: {
        label: "Media",
        description: "Inbound media filename preservation and retention settings",
      },
    },
    form: {
    ...
    modelsProviderModal: {
      ...
      descriptions: {
        ...
        local:
          "Quick-add a local Ollama, LM Studio, vLLM, or SGLang server with one model ID.",
        custom:
          "Define a fully custom provider ID and configure every field manually.",
      },
